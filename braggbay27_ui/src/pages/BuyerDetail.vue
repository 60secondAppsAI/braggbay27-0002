						...
						<td style="width: 100%;"></td>
				        	...
				        	<td style="width: 150px;">
								...
								<div id="app">
								  ...
								  <base-input label="ShippingAddress" type="text" placeholder="Enter ShippingAddress" v-model="buyerToAdd.shippingAddress"></base-input>
												                  </form>
								                </div>
            ...
            <div style="text-align: center; padding: 20px;">
              ...
              <button @click="handlePermissionDialogClose">OK</button>
					...
					<td class="detail_view_column_2">Shipping Address</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="ShippingAddress" type="text" placeholder="Enter ShippingAddress" v-model="buyerDetails.shippingAddress"></input>
																		</div>
						</td>
														</tr>
