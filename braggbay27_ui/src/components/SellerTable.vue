    ...
    return {
      ...
      columns: [
		...
		dataIndex: 'storeDescription',
          visible: true,
          scopedSlots: { customRender: 'storeDescription' },
          sorter: true
          //sorter: (a, b) => a.storeDescription - b.storeDescription,
          //sorter: (a, b) => a.storeDescription.localeCompare(b.storeDescription),
        },
      ],
      pagination: {
        current: 1,
